...
def minOperations(n):
    ...
    '''
    # If n is less than or equal to 1, it's impossible to achieve the target, return 0
    if n <= 1:
        return 0
    operations = 0
    ...
    # If n is greater than 1, it means n is a prime number greater than its square root.
    if n > 1:
        operations += n
